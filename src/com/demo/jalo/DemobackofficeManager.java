...
import com.demo.constants.DemobackofficeConstants;
 ...
 */
public class DemobackofficeManager extends GeneratedDemobackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(DemobackofficeManager.class.getName());
	 ...
	 */
	public static DemobackofficeManager getInstance()
	{
		return (DemobackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(DemobackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DemobackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of DemobackofficeManager called.");
		}
	}
